...
//
// Solidity: function isManager(address relayerAddress) constant returns(bool)
func (_Relayerhub *RelayerhubCaller) IsManager(opts *bind.CallOpts, relayerAddress common.Address) (bool, error) {
	var (
		ret0 = new(bool)
	)
	out := ret0
	err := _Relayerhub.contract.Call(opts, out, "isManager", relayerAddress)
	return *ret0, err
}
...
//
// Solidity: function isManager(address relayerAddress) constant returns(bool)
func (_Relayerhub *RelayerhubSession) IsManager(relayerAddress common.Address) (bool, error) {
	return _Relayerhub.Contract.IsManager(&_Relayerhub.CallOpts, relayerAddress)
}

// IsManager is a free data retrieval call binding the contract method 0xf3ae2415.
//
// Solidity: function isManager(address relayerAddress) constant returns(bool)
func (_Relayerhub *RelayerhubCallerSession) IsManager(relayerAddress common.Address) (bool, error) {
	return _Relayerhub.Contract.IsManager(&_Relayerhub.CallOpts, relayerAddress)
}
